...
import { bnToHex32, normalizeHex32 } from '../lib/util';
/**
 ...
 */
export function asEcKeyPairPublic(publicKey, yCoordinateIsOdd = null) {
 ...
 */
export function asSimpleSignature(ecSignature) {
  return {
 ...
 */
export function asSimplePublicKey(ecPublicKey) {
