...
export function useTokenData(): Record<TokenSymbol, TokenInfoData> {
  ...
  return {
    ...
    PINGU: {
      name: 'Pingu Exchange',
      image: iconpingu,
      description: 'The native token of Pingu Exchange, the high-performance perpetuals platform distributing 35% of protocol revenue to stakers',
      website: 'https://pingu.exchange/',
      twitter: 'https://x.com/pinguexchange',
      discord: 'https://discord.com/invite/pinguexchange',
