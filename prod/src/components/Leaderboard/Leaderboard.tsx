...
const Leaderboard: React.FC<LeaderboardProps> = ({
  ...
  useEffect(() => {
    const calculate = () => {
      const target = new Date('2025-08-01T00:00:00-04:00').getTime();
      ...
      {true && (
        <div className="connect-wallet-overlay">
          <div className="connect-wallet-content">
            <h2>{t('Season 0 is Over')}</h2>
            <p>{t('Thanks for participating!')}</p>
          </div>
        </div>
      )}
            ...
            <div className={`xp-display ${loading ? 'loading' : ''}`}>
              {loading ? (
                ...
                <span className="progress-bar-amount-header">
                  <NumberRoller
                    value={/* overview!.global_total_points*/ 0}
                    decimals={2}
                    duration={800}
                  />  {'\u00A0/ 10,000,000,000.00'}
            ...
            <div className="progress-bar">
              <div
                ...
                style={{
                  width: loading
                    ? '0%'
                    : `${(/* overview!.global_total_points */ 0 / 10_000_000_000) * 100}%`,
                }}
              />
            </div>
          </div>
          ...
          {!loading && (
            <div className="leaderboard-user-info">
              ...
              <div className="info-column">
                ...
                <div className="column-content">
                  <NumberRoller
                    value={/* overview!.boosted_points */ 0}
                    decimals={2}
                    duration={800}
                  />
                </div>
              ...
              <div className="info-column">
                ...
                <div className="column-content">
                  <NumberRoller
                    value={/* overview!.referral_points */ 0}
                    decimals={2}
                    duration={800}
                  />
                </div>
              ...
              <div className="info-column">
                ...
                <div className="column-content">#{ /* overview!.rank */ 0}</div>
              </div>
            </div>
          )}
        </div>
